...
JDK_URL_DEFAULT="https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.14%2B7/OpenJDK17U-jdk_x64_linux_hotspot_17.0.14_7.tar.gz"
...
if ! command -v g++ >/dev/null 2>&1; then
  echo "g++ not found, trying to install via apt/yum..."
