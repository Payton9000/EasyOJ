...
from app.models import Contest, ContestParticipant, ContestProblem, Problem, User
...
def build_problem_specs():
    ...
    ab_pairs = [
        (0, 0), (1, 2), (-5, 7), (999999999, 1), (-1000000000, -1000000000),
        (123456, -654321), (42, -42), (2147483647, -2147483648), (100000, 200000), (-999999, 123456),
    ]
    ...
    triple_cases = [
        (3, 9, 4), (-1, -3, -2), (7, 7, 1), (100, 100, 100),
        (-10, 0, -5), (999999, 12345, 888888), (5, 4, 3),
        (-1000000, 1000000, 0), (42, 42, 41), (-7, -7, -8),
    ]
    ...
    words = ['a', 'ab', 'abba', 'abcba', 'abca', 'aaaaabaaaaa', 'xyzzyx', 'xyzzx', 'racecar', 'easyoj']
    ...
    gcd_pairs = [
        (24, 18), (100, 75), (17, 13), (1, 999983), (270, 192),
        (123456, 7890), (99991, 97), (1000000000, 2), (999999937, 999999937), (84, 126),
    ]
    ...
    sum_arrays = [
        [1, 2, 3, 4, 5], [10, -2, 7], [42], [-1, -2, -3, -4, -5], [1000000, 1000000, -1000000],
        [0, 0, 0, 0], [9, 8, 7, 6, 5, 4], [3, -1, -2, 10, -10, 20], [999999999, 1], [5, -5, 5, -5, 5, -5, 5],
    ]
    range_sum_cases = []
    ...
    bs_raw = [
        ([1, 3, 7, 9, 11], 7), ([1, 2, 3, 4], 6), ([1, 2, 3, 4, 5, 6], 1), ([10, 20, 30, 40], 40),
        ([-5, -3, -1, 0, 2], -3), ([2, 4, 6, 8, 10, 12], 2), ([100], 100), ([100], -100),
        ([-10, -5, 0, 5, 10], 11), ([3, 6, 9, 12, 15, 18, 21], 15),
    ]
    bs_cases = []
    ...
    mod_pow_raw = [
        (2, 10, 1000), (3, 0, 5), (7, 13, 1000000007), (123456789, 123456, 1000003), (10, 9, 17),
        (99991, 99991, 998244353), (42, 42, 97), (5, 1234567, 19), (987654321, 2, 12345), (314159, 271828, 1009),
    ]
    ...
    lnds_raw = [
        [1, 2, 3, 4], [4, 3, 2, 1], [5, 5, 5, 5], [1, 3, 2, 4, 3, 5], [10, 9, 2, 5, 3, 7, 101, 18],
        [2, 2, 1, 2, 2, 3], [9, 1, 8, 2, 7, 3, 6, 4, 5], [0, -1, -1, -1, 2], [3, 1, 2, 2, 2, 4], [7],
    ]
    lnds_cases = []
    for arr in lnds_raw:
    ...
    subarray_raw = [
        ([1, 1, 1], 2), ([1, 2, 3], 3), ([0, 0, 0], 0), ([3, 4, -7, 1, 3, 3, 1, -4], 7), ([1, -1, 1, -1, 1], 0),
        ([5, -2, -3, 1, 2], 3), ([2, 2, 2, 2], 4), ([-1, -1, 1], 0), ([10, -10, 10, -10], 0), ([1, 3, -2, 5, -3, 2], 4),
    ]
    subarray_cases = []
    for arr, k in subarray_raw:
        subarray_cases.append((f"{len(arr)} {k}\\n{_format_int_line(arr)}", str(_subarray_sum_equals_k_count(arr, k))))
    problem_specs.append({
